      ...
      SELECT p.*,
        COALESCE(json_agg(
          json_build_object(
            'id', v."id",
            'qtdKit', v."qtdKit",
            'custoMaterial', v."custoMaterial",
            'custoMaoObra', v."custoMaoObra",
            'custoEmbalagem', v."custoEmbalagem",
            'custoArte', v."custoArte",
            ...
            'kitItens', (
              SELECT COALESCE(json_agg(json_build_object(
                ...
                'nomeProduto', ki."nomeProduto",
                'qtdItens', ki."qtdItens",
                'custoUnit', ki."custoUnit"
              )), '[]')
...
export async function POST(req: NextRequest) {
  try {
    ...
    await prisma.$executeRaw`
      INSERT INTO "PrecProduto" ("id", "workspaceId", "nome", "sku", "categoria")
      VALUES (${id}, 'ws_atelier', ${nome}, ${sku || null}, ${categoria || null})
    `
