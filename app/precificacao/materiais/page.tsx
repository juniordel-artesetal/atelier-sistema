  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={openNew} className="bg-purple-600 hover:bg-purple-700 text-white text-sm font-semibold px-4 py-2 rounded-lg">
          + Novo Material
        </button>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                ...
                <th className="px-4 py-3 text-center font-semibold text-gray-600">Preço pacote</th>
                <th className="px-4 py-3 text-center font-semibold text-gray-600">Qtd pacote</th>
                <th className="px-4 py-3 text-center font-semibold text-gray-600">Preço / unidade</th>
