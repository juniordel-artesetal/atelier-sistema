              ...
              {precoFinal > 0 && precoNormalCalc > 0 && (
                <div className="rounded-2xl overflow-hidden border-2 border-purple-300">
                  <div className="bg-purple-600 px-4 py-2">
                    <p className="text-xs font-bold text-purple-200 uppercase tracking-widest">🏷️ Preview — Destaque Promocional</p>
                  </div>
                    ...
                    {form.items.length > 0 && (
                      <div className="mt-3 pt-3 border-t border-gray-100">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {form.items.map(i => (
                            <span key={i.variacaoId} className="text-xs bg-purple-50 text-purple-700 px-2 py-0.5 rounded-full">
              ...
              <div key={combo.id} className="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
                ...
                <div className="p-5">
                  ...
                  <div className="mt-3 flex flex-wrap gap-1">
                    {combo.items.map(i => (
                      <span key={i.variacaoId} className="text-xs bg-purple-50 text-purple-600 px-2 py-0.5 rounded-full">
                        {i.qtd>1?`${i.qtd}× `:''}{i.nomeProduto}
                      </span>
                    ))}
                  </div>
