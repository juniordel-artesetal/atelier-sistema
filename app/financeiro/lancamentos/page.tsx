      ...
      <div className="bg-white rounded-xl border border-gray-100 p-4 flex flex-wrap gap-3">
        ...
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input value={busca} onChange={e => setBusca(e.target.value)} placeholder="Buscar..."
            className="w-full pl-8 border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-400" />
        </div>
      </div>
            ...
            <tbody>
              ...
              {!loading && filtered.length === 0 && (
                <tr><td colSpan={8} className="text-center py-10 text-gray-400 text-sm">
                  ...
                  <button onClick={() => openModal()} className="block mx-auto mt-2 text-purple-600 hover:underline text-xs">+ Adicionar primeiro lançamento</button>
                </td></tr>
              )}
              {filtered.map(row => (
